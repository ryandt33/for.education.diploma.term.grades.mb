  ...
  const content = {
    ...
    how_to: (
      <div>
        ...
        <p className="container__text">
          To export the term grades from ManageBac, go to the reporting tab on
          the left side of the screen (if your navigation menue is collapsed, it
          will be under Insights &gt; Reporting).
        </p>
        ...
        <p className="container__text">
          Then, click on the Reports History button at the top of the screen.
        ...
        <p className="container__text">
          In the top right corner, click on the three dots and then click "Make
          a copy"
        </p>{" "}
        <div className="container__image_box">
          <img
        ...
        <p className="container__text">
          In the popup, click on the New Data Source and select "Create data
          source".
        </p>{" "}
        <div className="container__image_box">
          <img
        ...
        <p className="container__text">
          Type in CSV, and upload your new CSV file.
        </p>{" "}
        <div className="container__image_box">
          <img
            src={ls_csv}
